...
function hotpCode(secret: string, counter: number): string {
  ...
  // Counter as big-endian 64-bit unsigned integer.
  // Current counters (~58M at time of writing) fit entirely in the low 32 bits.
 ...
 * Allows ±drift 30-second windows to tolerate clock skew on client devices.
 */
